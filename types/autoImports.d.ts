...
declare global {
  ...
  const AdvancedImageUpload: typeof import('../src/components/Upload/AdvancedImageUpload')['default']
  ...
  const CropImageUpload: typeof import('../src/components/Upload/CropImageUpload')['default']
  ...
  const FORM_GTE_100: typeof import('../src/utils/config')['FORM_GTE_100']
  const FORM_GT_ZERO: typeof import('../src/utils/config')['FORM_GT_ZERO']
  const FORM_LTE_1: typeof import('../src/utils/config')['FORM_LTE_1']
  const FORM_LTE_100: typeof import('../src/utils/config')['FORM_LTE_100']
  const FORM_LTE_10000: typeof import('../src/utils/config')['FORM_LTE_10000']
  const FORM_LT_100: typeof import('../src/utils/config')['FORM_LT_100']
  const FORM_NOT_NEGATIVE: typeof import('../src/utils/config')['FORM_NOT_NEGATIVE']
  ...
  const ImageCropper: typeof import('../src/components/Upload/ImageCropper')['default']
...
declare global {
  // @ts-ignore
  export type { NavData, MapPickerProps, FC, BusinessComponents, RangeValue, Langs, TableNavigationProps, ApiPageSelectProps, InitTableState, TableAction, ImageUploadProps, ImagePreviewProps, UploadImg, AdvancedImageUploadProps, ImageCropperProps, CropImageUploadProps, EditorProps, ThemeType, TabsData } from './autoImports.d'
